...
async function populateDatabase() {
    try {
        ...
        const items = [
            new Item("Arroz Branco".toLowerCase(), "Arroz branco tipo 1, pacote de 5kg".toLowerCase(), 12.50, 10),
            new Item("Feijão Preto".toLowerCase(), "Feijão preto carioca, pacote de 1kg".toLowerCase(), 8.90, 20),
            new Item("Óleo de Soja".toLowerCase(), "Óleo de soja refinado, garrafa de 900ml".toLowerCase(), 7.20, 30),
            new Item("Sal Refinado".toLowerCase(), "Sal refinado iodado, pacote de 1kg".toLowerCase(), 2.50, 20),
            new Item("Açúcar Cristal".toLowerCase(), "Açúcar cristal especial, pacote de 1kg".toLowerCase(), 4.80, 2),
            new Item("Macarrão Espaguete".toLowerCase(), "Massa de trigo espaguete, pacote de 500g".toLowerCase(), 3.90, 5),
            new Item("Tomate".toLowerCase(), "Tomate vermelho maduro, por kg".toLowerCase(), 6.50, 10),
            new Item("Cebola".toLowerCase(), "Cebola amarela, por kg".toLowerCase(), 4.20, 11),
            new Item("Alho".toLowerCase(), "Alho roxo nacional, por kg".toLowerCase(), 28.00, 12),
            new Item("Peito de Frango".toLowerCase(), "Peito de frango congelado, por kg".toLowerCase(), 14.90, 13),
            new Item("Carne Moída".toLowerCase(), "Carne bovina moída (patinho), por kg".toLowerCase(), 22.90, 15),
            new Item("Ovos".toLowerCase(), "Ovos brancos grandes, cartela com 12 unidades".toLowerCase(), 8.50, 18),
            new Item("Leite Integral".toLowerCase(), "Leite integral UHT, caixa de 1 litro".toLowerCase(), 4.20, 19),
            new Item("Queijo Mussarela".toLowerCase(), "Queijo mussarela fatiado, pacote de 200g".toLowerCase(), 9.80, 20),
            new Item("Pão de Forma".toLowerCase(), "Pão de forma integral, pacote de 500g".toLowerCase(), 6.90, 21),
            new Item("Manteiga".toLowerCase(), "Manteiga com sal, pote de 200g".toLowerCase(), 7.50 , 45),
            new Item("Farinha de Trigo".toLowerCase(), "Farinha de trigo tipo 1, pacote de 1kg".toLowerCase(), 5.20, 23),
            new Item("Batata".toLowerCase(), "Batata inglesa, por kg".toLowerCase(), 5.80, 3),
            new Item("Cenoura".toLowerCase(), "Cenoura orgânica, por kg".toLowerCase(), 7.20, 4),
            new Item("Azeite Extra Virgem".toLowerCase(), "Azeite de oliva extra virgem, garrafa de 500ml".toLowerCase(), 18.90, 6)
        ];
